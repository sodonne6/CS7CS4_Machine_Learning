...
length = len(text)
print(f'Length of dataset in characters: {length}')
...
with open('gpt_train_losses_model3.csv', mode='w', newline='') as f:
    writer = csv.writer(f)
    writer.writerow(['step', 'train_loss', 'val_loss'])
    for step, train_loss, val_loss in zip(step_list, train_losses, val_losses):
        writer.writerow([step, train_loss, val_loss])
